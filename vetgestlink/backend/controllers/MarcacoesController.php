...
use backend\models\MarcacoesSearch;
...
class MarcacoesController extends Controller
{
    ...
    {
        $searchModel = new MarcacoesSearch();
    ...
    /**
     * Updates an existing Marcacoes model.
    ...
    /**
     * Deletes an existing Marcacoes model.
