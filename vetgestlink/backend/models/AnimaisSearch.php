...
/**
 * AnimaisSearch represents the model behind the search form of `common\models\Animais`.
 */
class AnimaisSearch extends Animais
{
    /**
     * {@inheritdoc}
     */
    public function rules()
    {
        return [
            ...
            [['nome', 'datanascimento', 'notas', 'sexo'], 'safe'],
            [['peso'], 'number'],
        ];
    }
