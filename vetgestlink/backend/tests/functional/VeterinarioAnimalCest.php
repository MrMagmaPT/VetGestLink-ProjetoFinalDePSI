...
/**
 * Testes funcionais de acesso do Veterinário aos Animais.
 * 
 * Esta suite de testes verifica as permissões de acesso do papel
 * de Veterinário às funcionalidades de gestão de animais no sistema.
 */
class VeterinarioAnimalCest
{
    ...
    public function _before(FunctionalTester $I)
    {
        ...
        $this->veterinarioUser->username = 'veterinario_test_' . $timestamp;
        $this->veterinarioUser->email = 'veterinario_test_' . $timestamp . '@test.com';
     ...
     * Expectativa: Deve ver o dashboard e seu nome de usuário sem solicitação de novo login.
     */
    ...
    /**
     * Testa se o veterinário tem acesso à listagem de animais.
     * 
     * Cenário: Veterinário navega para a página de índice de animais.
     * Expectativa: Deve ver a página "Animais" sem mensagens de acesso negado.
     */
    public function testVeterinarioDeveAcessarListagemDeAnimais(FunctionalTester $I)
    {
