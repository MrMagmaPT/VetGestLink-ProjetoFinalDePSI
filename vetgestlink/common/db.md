...
CREATE TABLE IF NOT EXISTS `vetgestdb`.`faturas` (
  ...
  `metodospagamentos_id` INT NULL DEFAULT NULL,
  `userprofiles_id` INT NOT NULL,
  `eliminado` TINYINT NOT NULL DEFAULT '0',
  PRIMARY KEY (`id`),
...
-- -----------------------------------------------------
-- Table `vetgestdb`.`servicos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `vetgestdb`.`servicos` (
  `id` INT NOT NULL AUTO_INCREMENT,
  `nome` VARCHAR(45) NOT NULL,
...
CREATE TABLE IF NOT EXISTS `vetgestdb`.`marcacoes` (
  ...
  INDEX `fk_marcacoes_servicos1_idx` (`servicos_id` ASC),
  ...
  CONSTRAINT `fk_agendas_userprofiles`
    FOREIGN KEY (`userprofiles_id`)
    REFERENCES `vetgestdb`.`userprofiles` (`id`),
  CONSTRAINT `fk_marcacoes_servicos1`
    FOREIGN KEY (`servicos_id`)
    REFERENCES `vetgestdb`.`servicos` (`id`))
ENGINE = InnoDB
AUTO_INCREMENT = 3
DEFAULT CHARACTER SET = utf8mb3;
