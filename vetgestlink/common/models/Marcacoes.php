...
/**
 * This is the model class for table "marcacoes".
 *
 * @property int $id
 ...
 */
class Marcacoes extends \yii\db\ActiveRecord
{
    ...
    public function rules()
    {
        return [
            ...
            [['animais_id'], 'exist', 'skipOnError' => true, 'targetClass' => Animais::class, 'targetAttribute' => ['animais_id' => 'id']],
    ...
    {
        return $this->hasOne(Animais::class, ['id' => 'animais_id']);
    }
    ...
    {
        return $this->hasMany(Linhasfaturas::class, ['marcacoes_id' => 'id']);
    }
