    ...
    <div class="row g-3 align-items-end">
        ...
        <div class="col-md-6">
            <div class="d-flex align-items-center mb-2">
                <span class="me-2">
                    <!-- SVG User -->
                    <div class="text-muted me-2 small align-self-start "><i
                                class="fa-regular fa-address-card text-success"></i></div>
                </span>
                <div>
        ...
        <div class="col-md-6">
            <div class="d-flex align-items-center mb-2">
                <span class="me-2">
                    <!-- SVG Calendar -->
                    <div class="text-muted me-2 small align-self-start "><i
                                class="fa-regular fa-calendar text-success"></i></div>
                </span>
                <div>
...
<div class="mb-4">
    ...
    <div id="moradas-list">
        ...
        <div class="morada-item mb-3 border-bottom pb-3 position-relative">
            ...
            <?php if ($i > 0): ?>
                <button type="button" class="btn-close position-absolute top-0 end-0 remove-morada"
...
<?php
$script = <<< JS
$(document).on('click', '#btn-adicionar-morada', function() {
    $('#nova-morada-fields').slideToggle();
});
JS;
